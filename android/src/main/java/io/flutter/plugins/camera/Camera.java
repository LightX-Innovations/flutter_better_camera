...
public class Camera {
    ...
    private final CameraCompatibility cameraCompatibility;
    ...
    public Camera(
        ...
        cameraCompatibility = new CameraCompatibility(mCameraCharacteristics);
    ...
    public CameraCompatibility getCameraCompatibility() {
        return this.cameraCompatibility;
    }
        ...
        pictureImageReader.setOnImageAvailableListener(
                reader -> {
                    try (Image image = reader.acquireLatestImage()) {
                        ...
                        FileUtils.WriteToFile(buffer, file);
                        result.success(null);
                    } catch (IOException e) {
        ...
        try {
            ...
            if (sensorSensitivity != null || lensAperture != null || sensorExposure != null) {
                ...
                if (sensorSensitivity != null) {
                    captureBuilder.set(CaptureRequest.SENSOR_SENSITIVITY, sensorSensitivity);
                }
                if (lensAperture != null) {
                    captureBuilder.set(CaptureRequest.LENS_APERTURE, lensAperture);
                }
...
/*
        ...
        if (cameraCompatibility.isMeteringAreaAFSupported()) {
